...
public class P3_Amazon_cssSelector {
    public static void main(String[] args) {
        ...
        //Locating a web element by using css syntax
        WebElement searchBox = driver.findElement(By.cssSelector("input[id ='twotabsearchtextbox']"));

       // WebElement searchBox = driver.findElement(By.cssSelector("input#twotablesearchtextbox");

        searchBox.sendKeys("haircut kit" + Keys.ENTER);
